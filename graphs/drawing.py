...
def draw_all_paths(graph, paths: list):
    ...
    colors = ['red', 'orange', 'yellow', 'olive', 'green', 'blue', 'purple']
    linewidths = [1, 2, 3, 4, 5, 6, 7]
    for ctr, edgelist in enumerate(edges):
        nx.draw_networkx_edges(graph.path_G,pos=pos,edgelist=edgelist,edge_color = colors[ctr%7], width=linewidths[ctr%7])
    plt.show()
